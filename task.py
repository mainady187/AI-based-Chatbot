...
CHAT_RESPONSES = {
    ...
    "quit": "See you later! Session closed."
}
...
def get_bot_response(cleaned_message: str) -> str:
    """Get the bot response using flexible keyword matching from the dictionary."""
...
def main():
    """Main function to control the Streamlit UI and execution flow."""
    st.set_page_config(page_title="Rule-Based Chatbot", page_icon="🤖")
    st.title("Rule-Based AI Chatbot")
    st.write("Welcome to the Rule-Based AI Chatbot! Type your message below.")
